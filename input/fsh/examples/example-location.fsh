...
Usage: #example
Description: "Czech national core profile for location resource example. This profile implies use of the Czech standard organization in the managingOrganization element."
