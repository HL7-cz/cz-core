//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Profile:  CZ_CompositionCore
Parent:   CompositionEuCore
Id:       composition-cz-core
Title:    "Composition (CZ core)"
Description: """This profile introduces essential constraints and extensions for the Composition resource for commonly used in the Czech national EHDS compliant documents."""
//-------------------------------------------------------------------------------------------
* ^experimental = false
...
* extension[diagnosticReport].value[x] only Reference(CZ_DiagnosticReportCore)
/* * identifier 1..1
...
* subject 1..1
 */
* subject only Reference(CZ_PatientCore or Group or CZ_LocationCore or Device)
/* * encounter 0..1
* author 1..*
 */
* author only Reference(CZ_PractitionerCore or CZ_PractitionerRoleCore or CZ_OrganizationCore or Device or CZ_PatientCore or CZ_RelatedPersonCore)
//* date 1..1
//* title 1..1
 ...
 */
* attester[legalAuthenticator].party only Reference(CZ_PractitionerRoleCore or CZ_PractitionerCore) // Check references...
/*
