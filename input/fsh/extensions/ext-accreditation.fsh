...
Instance: AccreditationExample
InstanceOf: AccreditationCz
Title: "Accreditation example"
Description: "Example of the Accreditation extension with value true, indicating that the examination must be performed only by a laboratory accredited for the specific test."
Usage: #inline
* valueBoolean = true